...
set CESMDIR=/glade/work/glydia/cesm_tags/cesm2.2_derecho
...
if ($CONT_RUN == FALSE) then
	...
	# Runtime variables
	./xmlchange STOP_OPTION="nyears",RESUBMIT=0,STOP_N=5,JOB_WALLCLOCK_TIME=11:57:00,REST_N=5,REST_OPTION="nyears",CONTINUE_RUN=$CONT_RUN
...
if ($CONT_RUN == TRUE) then
	...
	./xmlchange JOB_QUEUE="main",JOB_WALLCLOCK_TIME=11:56:00
	./xmlquery JOB_QUEUE,JOB_WALLCLOCK_TIME
		
	# Do XMLCHANGE options for CONTINUE_RUN - 35 years
	./xmlquery STOP_N,STOP_OPTION,RESUBMIT,REST_N,CONTINUE_RUN
	./xmlchange STOP_N=5,STOP_OPTION="nyears",RESUBMIT=6,REST_N=5,REST_OPTION="nyears",CONTINUE_RUN=$CONT_RUN
